        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">Edit Job Category</h2>
                    <div class="space-x-2">
                        <a href="{{ route('job-categories.show', $category->id) }}" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">View Category</a>
                ...
                <form action="{{ route('job-categories.update', $category->id) }}" method="POST" class="mt-6">
                    @csrf
                    @method('PUT')

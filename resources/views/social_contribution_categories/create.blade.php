...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form method="POST" action="{{ route('social-contribution-categories.store') }}" class="bg-white p-6 rounded shadow space-y-4">
        ...
        <div>
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary" required />
